"""GPT model with xPOS (extrapolation-friendly position embeddings based on RoPE)."""
...
def gpt_xpos(token_id, pos_id, keys, values, state_dict, n_layer, n_head, head_dim, heads_per_group, n_embd):
